...
> 8. **多押按键均分**：新增设置开关。同一时刻按键数超过单手按键数时，开=对半均分到两只手（6押→R3 L3、7押→R4 L3、8押→R4 L4，单数多的一键给主手），关=主手取满后余数给另一手（6押→R5 L1）
> 9. **文档**：README 与中英文本地化文案同步更新
